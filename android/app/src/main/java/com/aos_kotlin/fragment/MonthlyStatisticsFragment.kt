...
import com.aos_kotlin.databinding.FragmentMonthlyStatisticsBinding
...
class MonthlyStatisticsFragment : Fragment() {
    private var _binding: FragmentMonthlyStatisticsBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMonthlyStatisticsBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun loadMonthlyStatistics() {
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            val workRecords = database.workRecordDao().getWorkRecordsByYearMonth(currentMonth)
